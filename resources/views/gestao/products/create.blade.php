...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <!-- /.box-header -->
                <!-- form start -->
                <form method="post" action="{{ route('gestao.products.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label>Valor</label>
                            <input type="text" name="value" value="{{old('value')}}" class="form-control money" id="amount"   placeholder="Valor do produto">
                        </div>


                        <div class="form-group">
                            <label for="description">Descrição</label>
                            <textarea class="textarea" id ="description" name="description" placeholder="Descrição"  style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{old('description')}}</textarea>
                        </div>

                        <div class="form-group">
                            <label for="stock">Quantidade em estoque</label>
                            <input type="number" name="stock" value="{{old('stock')}}" class="form-control" id="stock"  placeholder="Quantidade">
                        </div>
