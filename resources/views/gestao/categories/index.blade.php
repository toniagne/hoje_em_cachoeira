            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <a href="{{ route('gestao.categories.create') }}" class="btn btn-block btn-info">  <i class="fa fa-edit"></i> ADICIONAR UMA NOVA CATEGORIA</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td>{{ $category->name }}</td>
                                <td>
                                    <a class="btn btn-sm" href="{{ route('gestao.categories.edit', $category->id) }}"> <i class="fa fa-edit"></i>  </a>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form method="POST" action="{{ route('gestao.categories.destroy', $category->id) }}">
                                                    @method('DELETE')
                                                        @csrf
