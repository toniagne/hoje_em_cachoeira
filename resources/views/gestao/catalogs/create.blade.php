...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <!-- /.box-header -->
                <!-- form start -->
                <form method="post" action="{{ route('gestao.catalogs.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="value" name="value" value="{{ old('value') }}" placeholder="Valor">
                        </div>
                        <div class="form-group">
