        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                <div class="box-header">
                    <a href="{{ route('gestao.catalogs.create') }}" class="btn btn-block btn-info">  <i class="fa fa-edit"></i> ADICIONAR UM NOVO CATÁLOGO</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach ($catalogs as $catalog)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm" href="{{ route('gestao.catalogs.edit', $catalog->id) }}"> <i class="fa fa-edit"></i>  </a>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form method="POST" action="{{ route('gestao.catalogs.destroy', $catalog->id) }}">
                                                        @method('DELETE')
                                                        @csrf
