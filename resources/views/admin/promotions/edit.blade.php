...
@section('content-header')
   Editando promoções {{$promotion->name }} do cliente {{ $client->name }}
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <!-- /.box-header -->
                <!-- form start -->
                <form method="post" action="{{ route('promotions.update', [$promotion->id, $client->id]) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
                        <div class="form-group">
                            <label for="name">Título</label>
                            <input type="text" class="form-control" id="name" name="name" value="{{ $promotion->name }}" placeholder="Título da galeria">
                        </div>

                        <div class="form-group">
                            <label for="name">Dias ativos</label>
                            <input type="number" name="days" value="1" min="1" value="{{ $promotion->days }}">
                        </div>
