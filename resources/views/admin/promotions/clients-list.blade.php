...
@section('content-header')
    Promoções / Cliente: <b> {{ $client->name }}</b>
@endsection
        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                <div class="box-header">
                    <a href="{{ route('promotions.create', $client->id) }}" class="btn btn-block btn-info">  <i class="fa fa-edit"></i> ADICIONAR UMA NOVA PROMOÇÃO</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach ($catalogs as $catalog)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm" href="{{ route('promotions.edit', [$catalog->id, $client->id]) }}"> <i class="fa fa-edit"></i>  </a>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p>Você tem certeza que quer <strong>apagar</strong> esta promoção ?</p>

                                                    <h5>Lembre-se que os clientes atrelados à ela serão ocultados no site.</h5>

                                                </div>
                                                <div class="modal-footer">
                                                    <form method="POST" action="{{ route('promotions.destroy', [$catalog->id, $client->id]) }}">
                                                        @method('DELETE')
                                                        @csrf
