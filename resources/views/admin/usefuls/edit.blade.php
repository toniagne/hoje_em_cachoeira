...
@section('content-header')
    Editando Úteis <b>{{ $contract->client->name }}</b>
@endsection
            ...
            <!-- /.box-header -->
                ...
                <form method="POST" action="{{ route('usefuls.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="exampleInputFile">Imagem Principal / Logo</label><br>
                            <br>
                            <img src="{{ asset('storage/public/'.$contract->file) }}" height="50" class="img-bordered"><br>
