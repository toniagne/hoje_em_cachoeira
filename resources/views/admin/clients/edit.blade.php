                                        ...
                                        <div class="tab-pane active" id="tab1">
                                            <div class="box-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="company" name="company" value="{{ $client->company }}" placeholder="Razão Social">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="address"  class="form-control" value="{{ $client->address }}" id="address" placeholder="Endereço completo">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="textarea" name="services" placeholder="Serviços que a empresa presta"  style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{!! $client->services !!}</textarea>
                                                </div>
