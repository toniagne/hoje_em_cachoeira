            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <a href="{{ route('categories.create') }}" class="btn btn-block btn-info">  <i class="fa fa-edit"></i> ADICIONAR UMA NOVA CATEGORIA</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{asset('storage/public/'.$category->icon)}}" class="img-bordered-sm img-fluid" height="100px" /><br>

                                </td>
                                <td>{{ $category->name }}</td>
                                <td>
                                    <a class="btn btn-sm" href="{{ route('categories.edit', $category->id) }}"> <i class="fa fa-edit"></i>  </a>
