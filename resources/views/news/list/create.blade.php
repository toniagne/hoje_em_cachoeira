                ...
                <form method="post" action="{{ route('news.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="title" name="title" value="{{ old('name') }}" placeholder="Nome">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="body" class="textarea" name="body" placeholder="Corpo da notícia"  style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{old('body')}}</textarea>
                        </div>


                        <div class="form-group">
                            <label for="link">Link do banner</label>
                            <input type="text" class="form-control" id="link" name="link" value="{{ old('description') }}" placeholder="Descrição">
                        </div>
